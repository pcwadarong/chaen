...
vi.mock('@/features/browse-articles/model/use-browse-articles', () => ({
  useBrowseArticles: vi.fn(),
}));
 ...
 * 아티클 피드 훅 목을 반환합니다.
 */
const getUseBrowseArticlesMock = async () => {
  const articleFeedModule = await import('@/features/browse-articles/model/use-browse-articles');

  return vi.mocked(articleFeedModule.useBrowseArticles);
};
