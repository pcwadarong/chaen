...
import type { WorkListPageProps } from '../ui/work-list-page';

type GetWorkListPageDataInput = {
  locale: string;
};
 ...
 */
export const getWorkListPageData = async ({
  locale,
}: GetWorkListPageDataInput): Promise<WorkListPageProps> => {
