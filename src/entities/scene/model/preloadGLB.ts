 ...
 */
export const CHARACTER_MODEL_PATH = '/models/character.v4.glb';
export const BASS_MODEL_PATH = '/models/bass.v4.glb';
export const TABLE_MODEL_PATH = '/models/table.v4.glb';
export const SOFA_MODEL_PATH = '/models/sofa.v4.glb';
